...
Route::middleware('api')->group(function () {
    Route::middleware('auth:api')->group(function () {
        ...
        Route::post('get_flag_data', [PosController::class, 'getFlagData']);
        ...
        Route::post('rekap-v2', [PosController::class, 'rekapV2']);
        ...
        Route::group(['prefix' => 'journal'], function () {
            ...
            Route::post('payment-delete', [HutangController::class, 'paymentDelete']);
            ...
            Route::post('piutang-payment-delete', [PiutangController::class, 'paymentDelete']);
            ...
            Route::post('penyusutan-lost-store', [PenyusutanController::class, 'lostStore']);
            Route::post('akun-bayar-dengan', [PenyusutanController::class, 'akuns']);
