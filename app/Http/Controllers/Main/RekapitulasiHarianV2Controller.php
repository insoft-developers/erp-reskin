...
class RekapitulasiHarianV2Controller extends Controller
{
    public function index(Request $request)
    {
        ...
        $info = \App\Models\MlAccountInfo::where('user_id',  $this->get_owner_id(session('id')))->first();
        ...
        return view('main.rekapitulasi_harian.index2', compact('view', 'data', 'userKey', 'from', 'date','banks','piutang'));
    }
