                ...
                <div class="row">
                    ...
                    <div class="col-xxl-12">
                        <div class="card stretch stretch-full">
                            ...
                            @endif --}}
                            <form method="POST" action="{{ route('account.profile.update.api', ['id' => $account->id]) }}"
                                ...
                                <div class="card-body custom-card-action p-0">
                                    <div class="container mtop30 main-box">
                                        ...
                                        <div class="row mtop20">
                                            <div class="col-md-12">
                                                <div class="p-4 bg-soft-warning rounded-3">
                                                    <p class="fs-12 text-dark"><strong>Ganti Email & Nomor
                                                            Handphone</strong><br>
                                                        Jika ingin mengganti email dan nomor handphone silakan request
                                                        melalui "Live Chat" di Pojok Kanan Bawah
                                                    </p>
                                                    <p class="fs-12 text-dark"><strong>Ganti Username</strong><br>
                                                        JIka ingin menggantu username silakan menuju ke menu "Storefront"
                                                        lalu "Pengaturan Toko Online"
                                                    </p>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="fullname" id="name"
                                                        class="form-control cust-control" value="{{ $account->fullname }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mtop10">
                                        ...
                                        <div class="row mtop10">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="account_type" type="text" id="accountType"
                                                        class="form-control cust-control" readonly
                                                        value="{{ $account->is_upgraded ? 'Premium' : 'Free User' }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mtop10">
                                            <div class="col-md-12">
                                                ...
                                                <input name="expire" id="expire" type="text"
                                                    class="form-control cust-control" readonly
                                                    value="{{ !is_null($account->upgrade_expiry) ? \Carbon\Carbon::parse($account->upgrade_expiry)->format('d M Y H:i:s') : '-' }}">
                                            </div>
                                        </div>
                                        <div class="row mtop10">
                                            <div class="col-md-12">
                                                <label>Referral / Sales</label>
                                                <input name="referral" id="refererral" type="text"
                                                    class="form-control cust-control" readonly
                                                    value="{{ $account->referal_source }}">
                                            </div>
                                        </div>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <span class="input-group-text" style="height: 35px;">
                                                        <i class="fa fa-eye toggle-password" data-target="#oldPassword"
                                        ...
                                        <div class="form-group mtop10">
                                            ...
                                            <div class="input-group">
                                                <input name="password_confirmation" type="password"
                                                    id="newPasswordConfirmation" class="form-control cust-control"
                                        ...
                                        <div class="form-group mtop10">
                                            ...
                                            <div class="input-group">
                                                <input name="pin" value="{{ $account->pin }}" type="password"
                                                    onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                                    id="pin" class="form-control cust-control"
                                                    placeholder="Masukkan PIN jika ingin mengubah PIN. 6 Digit angka"
                                                    maxlength="6">
                                            </div>
                                        ...
                                        <div class="form-group mtop20">
                                            ...
                                            <input name="clock_in" type="time" id="clock_in"
                                                value="{{ $account->clock_in ?? null }}"
                                                class="form-control cust-control">
                                        </div>
                                        <div class="form-group mtop20">
                                            <label>Jam Pulang:</label>
                                            <input name="clock_out" type="time" id="clock_out"
                                                value="{{ $account->clock_out ?? null }}"
                                                class="form-control cust-control">
                                        </div>
                                        <div class="form-group mtop20">
                                            <div class="accordion-item mb-3">
                                                <h2 class="accordion-header" id="panelsStayOpen-headingFour">
                                                    <button class="accordion-button collapsed btn btn-primary"
                                                        type="button" 
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-check shipping"
                                                                                    ...
                                                                                    <input class="form-check-input"
                                                                                        ...
                                                                                        type="checkbox" id="Senin"
                                                                                        value="Senin"
                                                                                        {{ isset($account->holiday) && is_array(json_decode($account->holiday, true)) && in_array('Senin', json_decode($account->holiday)) ? 'checked' : '' }}>
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-check shipping"
                                                                                    ...
                                                                                    <input class="form-check-input"
                                                                                        name="holiday[]"
                                                                                        onclick="validateHoliday()"
                                                                                        type="checkbox" id="Selasa"
                                                                                        value="Selasa"
                                                                                        {{ isset($account->holiday) && is_array(json_decode($account->holiday, true)) && in_array('Selasa', json_decode($account->holiday)) ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-check shipping"
                                                                                    ...
                                                                                    <input class="form-check-input"
                                                                                        name="holiday[]"
                                                                                        onclick="validateHoliday()"
                                                                                        type="checkbox" id="Rabu"
                                                                                        value="Rabu"
                                                                                        {{ isset($account->holiday) && is_array(json_decode($account->holiday, true)) && in_array('Rabu', json_decode($account->holiday)) ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                                                                        for="Rabu">Rabu</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <div class="form-check shipping"
                                                                                    ...
                                                                                    <input class="form-check-input"
                                                                                        name="holiday[]"
                                                                                        onclick="validateHoliday()"
                                                                                        type="checkbox" id="Kamis"
                                                                                        value="Kamis"
                                                                                        {{ isset($account->holiday) && is_array(json_decode($account->holiday, true)) && in_array('Kamis', json_decode($account->holiday)) ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-check shipping"
                                                                                    ...
                                                                                    <input class="form-check-input"
                                                                                        name="holiday[]"
                                                                                        onclick="validateHoliday()"
                                                                                        type="checkbox" id="Jumat"
                                                                                        value="Jumat"
                                                                                        {{ isset($account->holiday) && is_array(json_decode($account->holiday, true)) && in_array('Jumat', json_decode($account->holiday)) ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-check shipping"
                                                                                    ...
                                                                                    <input class="form-check-input"
                                                                                        name="holiday[]"
                                                                                        onclick="validateHoliday()"
                                                                                        type="checkbox" id="Sabtu"
                                                                                        value="Sabtu"
                                                                                        {{ isset($account->holiday) && is_array(json_decode($account->holiday, true)) && in_array('Sabtu', json_decode($account->holiday)) ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                                                            ...
                                                                            <div class="col-sm-6">
                                                                                <div class="form-check shipping"
                                                                                    ...
                                                                                    <input class="form-check-input"
                                                                                        name="holiday[]"
                                                                                        onclick="validateHoliday()"
                                                                                        type="checkbox" id="Minggu"
                                                                                        value="Minggu"
                                                                                        {{ isset($account->holiday) && is_array(json_decode($account->holiday, true)) && in_array('Minggu', json_decode($account->holiday)) ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                            ...
                                            <div class="row mtop20">
                                                <div class="col-md-12 d-flex justify-content-start">
                                                    ...
                                                    <button class="btn btn-primary" type="submit" id="submitBtn"
                                                        {{ $account->pin ? '' : 'disabled' }}>Simpan</button>
                                                </div>
                                            </div>
            ...
            function show_validation_errors(errors) {
                ...
                $.each(errors, function(field, messages) {
                    ...
                    $.each(messages, function(index, message) {
                        inputGroupAppend.after('<div class="invalid-feedback">' + message +
                            '</div>');
                    });
                });
            }
            $("#formUpdateAccount").submit(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        Swal.fire('Success', data.message, 'success').then((val) => window
