                ...
                <div class="row">
                    ...
                    <div class="col-xxl-12">
                        <div class="card stretch stretch-full">
                            ...
                            <form method="POST" action="{{ route('save-printer') }}" enctype="multipart/form-data"
                                id="formUpdate">
                                @csrf
                                        ...
                                        <div class="row mtop10">
                                            <div class="col-md-12">
                                                <label for="is_rounded" class="form-label">Pembulatan Transaksi
                                                    <div>
                                                        <small>Jika Transaksi dibawah Rp 500 Transaksi akan dibulatkan ke
                                                            bawah, jika diatas Rp 500 Transaksi akan dibulatkan ke
                                                            atas</small>
                                                    </div>
                                                </label>
                                                <div class="input-group">
                                                    <div class="form-check" style="margin-right: 10px;">
                                                        <input class="form-check-input" type="radio" name="is_rounded"
                                                            id="is_rounded1" value="1"
                                                            {{ $data->is_rounded == true ? 'checked' : '' }}>
                                                    ...
                                                    <div class="form-check" style="margin-right: 10px;">
                                                        <input class="form-check-input" type="radio" name="is_rounded"
                                                            id="is_rounded2" value="0"
                                                            {{ $data->is_rounded == false ? 'checked' : '' }}>
                                                ...
                                                <div class="input-group">
                                                    <div class="form-check" style="margin-right: 10px;">
                                                        <input class="form-check-input" type="radio"
                                                            name="printer_connection" id="printer_connection1"
                                                            value="bluetooth"
                                                            {{ $data->printer_connection == 'bluetooth' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="form-check" style="margin-right: 10px;">
                                                        <input class="form-check-input" type="radio"
                                                            name="printer_connection" id="printer_connection2"
                                                            value="usb"
                                                            {{ $data->printer_connection == 'usb' ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-12" style="display: none;">
                                                ...
                                                <div class="input-group">
                                                    <div class="form-check" style="margin-right: 10px;">
                                                        <input class="form-check-input" type="radio"
                                                            name="printer_paper_size" id="printer_paper_size1"
                                                            value="5.8"
                                                            {{ $data->printer_paper_size == '5.8' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="form-check" style="margin-right: 10px;">
                                                        <input class="form-check-input" type="radio"
                                                            name="printer_paper_size" id="printer_paper_size2"
                                                            value="8.0"
                                                            {{ $data->printer_paper_size == '8.0' ? 'checked' : '' }}>
                                            ...
                                            <div class="mtop20">
                                                ...
                                                <textarea class="form-control cust-cuntrol" id="printer_custom_footer" name="printer_custom_footer"
                                                    placeholder="Custom Footer">{{ $data->printer_custom_footer }}</textarea>
                                            </div>
