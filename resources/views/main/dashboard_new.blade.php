                                ...
                                <div class="col-xl-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h6 class="fs-16 fw-semibold mb-0 text-truncate">{{ number_format($invoices) }}
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h6 class="fs-16 fw-semibold mb-0 text-truncate">
                                                {{ number_format($overdue_total) }}</h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                ...
                                <div class="col-xl-6">
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <div>
                                            ...
                                            <h6 class="fs-16 fw-semibold mb-0 text-truncate">
                                                {{ number_format($total_purchases) }}</h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                ...
                                <div class="col-xl-6">
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <div>
                                            ...
                                            <h6 class="fs-16 fw-semibold mb-0 text-truncate">
                                                {{ number_format($penjualan_not_paid) }}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-4 d-flex flex-column">
                    <div class="card overflow-hidden z-1 flex-fill">
                        <div class="card-body">
                            ...
                            <a href="{{ url('main_material') }}" class="fw-medium text-decoration-underline">View All
                                Material</a>
                        </div> <!-- end card body -->
                        <div class="position-absolute end-0 bottom-0 z-n1">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h6 class="fs-14 fw-medium mb-1"><a
                                                                    href="javascript:void(0);">{{ $cl->name }}</a>
                                                            </h6>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($penjualan_8 as $p8)
                                            <tr>
                                                <td>
                                                    <a href="javascript:void(0);"
                                                        class="link-default">{{ $p8->reference }}</a>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <h6 class="fs-14 fw-medium mb-0">
                                                                <a
                                                                    href="javascript:void(0);">{{ $p8->customer_id == null ? $p8->cust_name : $p8->customer->name }}</a>
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-dark">
                                                    {{ $p8->payment_method === 'randu-wallet' ? 'wallet' : $p8->payment_method }}
                                                </td>
                                                <td><?= $p8->detail ?></td>
                                            </tr>
                                        @endforeach
                        ...
                        <div class="card-body pb-1">
                            ...
                            @foreach ($recent['today'] ?? [] as $p)
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="fs-14 fw-semibold mb-1"><a
                                                    href="javascript:void(0);">{{ $p->customer_id == null ? $p->cust_name : $p->customer->name }}</a>
                                            </h6>
                                    ...
                                    <div class="text-end">
                                        <span
                                            class="badge badge-lg badge-soft-success">{{ number_format($p->paid) }}</span>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            @foreach ($q_list as $qlist)
                                <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="fs-14 fw-semibold mb-1"><a
                                                    href="javascript:void(0);">{{ $qlist->name }}</a></h6>
                                    ...
                                    <div class="text-end">
                                        ...
                                        @else
                                            <span
                                                class="badge badge-sm badge-soft-danger d-inline-flex align-items-center mb-1">Not
                                                Paid<i class="isax isax-delete-circle ms-1"></i></span>
                                        @endif
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-1 mb-3">
                                ...
                                @foreach ($top_products as $index => $top)
                                    ...
                                    <p class="d-flex align-items-center fs-13 text-dark mb-0"><i
                                            class="fa-solid fa-circle fs-8 me-1 {{ $colors[$index] }}"></i>{{ $top->product_name }}
                                    </p>
                                @endforeach
                                @php
                                    ...
                                    $a1 =
                                        isset($top_products[0]) && $total_quantity > 0
                                            ? ($top_products[0]->total_qty / $total_quantity) * 100
                                            : 0;

                                    $a2 =
                                        isset($top_products[1]) && $total_quantity > 0
                                            ? ($top_products[1]->total_qty / $total_quantity) * 100
                                            : 0;

                                    $a3 =
                                        isset($top_products[2]) && $total_quantity > 0
                                            ? ($top_products[2]->total_qty / $total_quantity) * 100
                                            : 0;
