        ...
        <div class="nxl-content">
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('crm.followup.index') }}">Edit Followup</a></li>
            ...
            <div class="main-content">
                <div class="row">
                    ...
                    <div class="col-xxl-12">
                        ...
                        @endif
                        <form method="POST" action="{{ route('crm.followup.update', [$data->id]) }}" class="card stretch stretch-full" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body custom-card-action p-4">
                                <div class="mb-4">
                                    <div class="col-12 col-xxl-12">
                                        ...
                                        <select class="form-select @error('type') is-invalid @enderror"
                                            ...
                                            <option value="followup" {{ ($data->type == 'followup') ? 'selected' : '' }}>Followup</option>
                                            <option value="upselling" {{ ($data->type == 'upselling') ? 'selected' : '' }}>Upselling</option>
                                        </select>
                                        @error('type')
                                ...
                                <div class="mb-4">
                                    <div class="col-12 col-xxl-12">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            id="name" name="name" value="{{ old('name', $data->name) }}" placeholder="Whatsapp Followup 1">
                                        </input>
                                        @error('name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="text" id="script_header" class="form-control" cols="30" rows="10">{{ old('script_header', $data->text) }}</textarea>
                                    <div class="form-text">
