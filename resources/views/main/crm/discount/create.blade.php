<form method="POST" id="formCreate" action="{{ route('crm.discount.store') }}" enctype="multipart/form-data">
    @csrf
            ...
            <div class="mb-4">
                <div class="col-12 col-xxl-12">
                    ...
                    <input type="text" class="form-control @error('value') is-invalid @enderror"
                        id="value" name="value" value="{{ old('value') }}" placeholder="Nilai">
                    </input>
                    @error('value')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="mb-4">
                <div class="col-12 col-xxl-12">
                    ...
                    <input type="text" class="form-control @error('min_order') is-invalid @enderror"
                        id="min_order" name="min_order" value="{{ old('min_order') }}" placeholder="200.000">
                    </input>
                    @error('min_order')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="mb-4">
                <div class="col-12 col-xxl-12">
                    ...
                    <input type="date" class="form-control @error('expired_at') is-invalid @enderror"
                        id="expired_at" name="expired_at" value="{{ old('expired_at') }}" placeholder="">
                    </input>
                    @error('expired_at')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            {{-- <div class="mb-4">
                <div class="col-12 col-xxl-12">
                    ...
                    <input type="number" class="form-control @error('max_use') is-invalid @enderror"
                        id="max_use" name="max_use" value="{{ old('max_use') }}" placeholder="">
                    </input>
                    @error('max_use')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
