                        ...
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body custom-card-action p-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <button type="button" class="btn bg-danger-gradient btn-danger btn-effect" id="delete-btn" hidden>
                                            <i class="feather-trash-2"></i> Bulk Delete
                                        </button>
                                    </div>
                                    <div class="col-md-3">
                                        <button type="button" class="btn bg-success-gradient btn-success btn-effect" id="sync-btn" hidden>
...
@section('js')
    <script type="text/javascript">
        ...
        function delete_payment(id) {
            ...
            $.ajax({
                url: "{{ route('utang.delete.payment') }}",
                type: "POST",
                dataType: "JSON",
                data: {
                    "id": id,
        ...
        function unsync_payment(id) {
            var csrf_token = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                url: "{{ route('utang.unsync.payment') }}",
                type: "POST",
                dataType: "JSON",
                data: {
                    "id": id,
        ...
        function deleteData(event, id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                            url: "{{ route('utang.destroy', ':id') }}".replace(':id', id),
                            type: 'POST',
                            data: postForm,
                            dataType: 'json',
                        })
        ...
        function detail(id) {
            $.ajax({
                    url: "{{ route('utang.show', ':id') }}".replace(':id', id),
                    type: 'GET',
                })
                .done(function(data) {
                    $('#content-modal-ce').html(data);
        ...
        function payment(id) {
            $.ajax({
                    url: "{{ route('utang.todoPayment', ':id') }}".replace(':id', id),
                    type: 'GET',
                })
                .done(function(data) {
                    $('#content-modal-ce').html(data);
