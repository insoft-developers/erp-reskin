            ...
            <div style="background: whitesmoke;" class="content">
                <div class="row">
                    ...
                    <div class="col-xxl-12">
                        ...
                        @endif
                        <form method="POST" action="{{ route('landing-page.store') }}" class="card stretch stretch-full"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="card-header">
                                <h5 class="card-title">Landing Page</h5>

                                <a style="float:right;" href="/landing-page" class="btn bg-danger-gradient btn-danger btn-effect">Kembali</a>
                            </div>
                            <div class="card-body custom-card-action p-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="script_header" id="script_header" class="form-control">{{ old('script_header') }}</textarea>
                                    <div class="form-text">
                                ...
                                <div class="mb-4">
                                    <label for="script_header_payment_page" class="form-label">Script Header Payment
                                        Page</label>
                                    <textarea name="script_header_payment_page" id="script_header_payment_page" class="form-control">{{ old('script_header_payment_page') }}</textarea>
                                    <div class="form-text">
                                ...
                                <div class="mb-4">
                                    <label for="script_header_wa_page" class="form-label">Script Header Click To
                                        Whatsapp</label>
                                    <textarea name="script_header_wa_page" id="script_header_wa_page" class="form-control">{{ old('script_header_wa_page') }}</textarea>
                                    <div class="form-text">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" data-select2-selector="default"
                                        ...
                                        <option value="{{ 0 }}"
                                            @if (old('click_to_wa') == 0) selected @endif>
                                            Non Aktif
                                        </option>
                                        <option value="{{ 1 }}"
                                            @if (old('click_to_wa') == 1) selected @endif>
                                            Aktif
                                        </option>
                                    </select>
                                    <div class="form-text">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="Phone" name="contact_seller"
                                        id="contact_seller" disabled
                                        value="{{ $user->information[0]->phone_number ?? '' }}" />
                                </div>
                                <h4>Data Pelanggan</h4>
                                <div class="form-check form-switch form-switch-sm ps-5">
                                    <input @if (old('with_customer_name')) checked @endif
                                ...
                                <div class="form-check form-switch form-switch-sm ps-5">
                                    <input @if (old('with_customer_wa_number')) checked @endif
                                ...
                                <div class="form-check form-switch form-switch-sm ps-5">
                                    <input @if (old('with_customer_email')) checked @endif
                                ...
                                <div class="form-check form-switch form-switch-sm ps-5">
                                    <input @if (old('with_customer_full_address')) checked @endif
                                ...
                                <div class="form-check form-switch form-switch-sm ps-5">
                                    <input @if (old('with_customer_proty')) checked @endif
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-12 col-xl-3 mb-4">
                                        ...
                                        <div class="input-group flex-nowrap">
                                            ...
                                            <input type="number" class="form-control" id="bump_product_discount"
                                                ...
                                                value="{{ old('bump_product_discount') }}" />
                                        </div>
                                        <div class="form-text">
                                    ...
                                    <div class="col-12 col-xl-6 mb-4">
                                        ...
                                        <input type="text" class="form-control" id="bump_product_custom_name"
                                            ...
                                            value="{{ old('bump_product_custom_name') }}" />
                                        <div class="form-text">
                                    ...
                                    <div class="col-12 col-xl-6 mb-4">
                                        ...
                                        <input type="text" class="form-control" id="bump_product_title"
                                            name="bump_product_title" value="{{ old('bump_product_title') }}" />
                                        <div class="form-text">
                                    ...
                                    <div class="col-12 col-xl-6 mb-4">
                                        ...
                                        <textarea class="form-control" id="bump_product_description" name="bump_product_description">{{ old('bump_product_description') }}</textarea>
                                        <div class="form-text">
                                    ...
                                    <div class="col-12 col-xl-6 mb-4">
                                        ...
                                        <input type="file" class="form-control" id="bump_product_custom_photo"
                                            name="bump_product_custom_photo" accept="image/*" />
                                        <div class="form-text">
                                            Jika anda ingin menggunakan foto kustom untuk bump produk.
                                        </div>
                                        <div id="imagePreview" style="max-width: 100%; max-height: 300px;"></div>
                                    </div>
                                </div>
                                <hr class="my-4">
                                <div class="mb-4">
                                    ...
                                    <input checked type="text"
                                        ...
                                        value="{{ old('text_submit_button') ?? 'Mulai Order Sekarang' }}">
                                    <div class="form-text">
