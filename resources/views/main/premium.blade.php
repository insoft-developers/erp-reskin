                    ...
                    <h5 class="fw-semibold mb-3" style="font-size: 1.875rem;">Profit Dulu, Upgrade Kemudian</h1>
                        <div class="text-muted mb-4" style="font-size: 0.95rem;">
                            <p class="mb-3"><strong>Terima Kasih Telah Menjadi Pengguna Setia Aplikasi&nbsp;
                                    Reskin</strong><br>Jika bisnis Anda belum menghasilkan profit (keuntungan) Anda dapat
                        ...
                        <div class="row mt-8">
                            @if ($data['versi gratis']->is_active)
                                <div class="col-lg-4 mb-3">
                                    <div class="border rounded-4 p-4 bg-white shadow">
                                        ...
                                        <p class="mb-2"><span
                                                class="h1 fw-semibold">Rp{{ $data['versi gratis']->format_price }}</span>
                                            Selamanya</p>
                                        ...
                                        <ul class="list-unstyled mb-4 custom-list">
                                            <li class="fw-semibold text-muted"><i
                                                    ...
                                                    style="line-height: 1.20em !important;"></i> Reskin POS & Kasir</li>
                                            <li class="fw-semibold text-muted"><i
                                                    class="fs-3 fas fa-check-square text-success me-3"
                                                    style="line-height: 1.20em !important;"></i> Reskin Inventory</li>
                                            <li class="fw-semibold text-muted"><i
                                                    class="fs-3 fas fa-check-square text-success me-3"
                                                    style="line-height: 1.20em !important;"></i> Reskin Jurnal Akuntansi</li>
                                            <li class="fw-semibold text-muted"><i
                                                    class="fs-3 fas fa-check-square text-success me-3"
                                                    style="line-height: 1.20em !important;"></i> Reskin QR Meja (Table)</li>
                                            <li class="fw-semibold text-muted"><i
                                                    class="fs-3 fas fa-check-square text-success me-3"
                                                    style="line-height: 1.20em !important;"></i> Reskin Manufaktur</li>
                                            <li class="fw-semibold text-muted"><i
                                                    class="fs-3 fas fa-check-square text-success me-3"
                                                    style="line-height: 1.20em !important;"></i> Reskin CRM</li>
                                            <li class="fw-semibold text-muted"><i
                                                    class="fs-3 fas fa-check-square text-success me-3"
                                                    style="line-height: 1.20em !important;"></i> Reskin Landingpage & Toko
                                                Online</li>
                                            <li class="fw-semibold text-muted"><i
                                                    class="fs-3 fas fa-check-square text-success me-3"
                                                    style="line-height: 1.20em !important;"></i> Reskin Invoice & Pembayaran
                                            </li>
                                            <li class="fw-semibold text-muted"><i
                                                    class="fs-3 fas fa-check-square text-success me-3"
                                                    style="line-height: 1.20em !important;"></i> Reskin AI (Kecerdasan
                                                Buatan)
                                            </li>
                                            <li class="fw-semibold text-muted"><i
                                                    class="fs-3 fas fa-check-square text-success me-3"
                            ...
                            <h5 class="fw-semibold mb-3" style="font-size: 1.875rem;">
                                </h1>
                                <div class="text-muted mb-4" style="font-size: 0.95rem;">
                                    <p class="mb-3">Namun, apabila bisnis Anda sudah menghasilkan keuntungan kami
                                        mengundang Anda untuk meng-upgrade
                                        ke versi premium dengan biaya hanya Rp819 per hari.</p>
                                    <p class="mb-3">Jika Anda menjalankan bisnis nirlaba (yayasan, panti asuhan, atau
                                        organisasi)
                                        atau menggunakan Reskin untuk keperluan pendidikan baik sebagai pengajar maupun
                                        siswa,
                                        silakan hubungi kami melalui menu ticketing untuk mendapatkan akses premium secara
                                        gratis.
                                    </p>
                                    <p><strong>Tim Reskin,</strong> Sayangku Padamu Selalu</span></p>
                                </div>
                                <div class="row mt-8">
                                        ...
                                        <div class="col-lg-4 mb-3">
                                            <div class="border rounded-4 p-4 bg-white shadow">
                                                ...
                                                <ul class="list-unstyled mb-4 custom-list">
                                                    <li class="fw-semibold text-muted"><i
                                                            class="fs-3 fas fa-check-square text-success me-3"
                                                            style="line-height: 1.20em !important;"></i> Reskin POS & Kasir
                                                    </li>
                                                    <li class="fw-semibold text-muted"><i
                                                            class="fs-3 fas fa-check-square text-success me-3"
                                                            style="line-height: 1.20em !important;"></i> Reskin Inventory
                                                    </li>
                                                    <li class="fw-semibold text-muted"><i
                                                            class="fs-3 fas fa-check-square text-success me-3"
                                                            style="line-height: 1.20em !important;"></i> Reskin Jurnal
                                                        Akuntansi</li>
                                                    <li class="fw-semibold text-muted"><i
                                                            class="fs-3 fas fa-check-square text-success me-3"
                                                            style="line-height: 1.20em !important;"></i> Reskin QR Meja
                                                        (Table)</li>
                                                    <li class="fw-semibold text-muted"><i
                                                            class="fs-3 fas fa-check-square text-success me-3"
                                                            style="line-height: 1.20em !important;"></i> Reskin Manufaktur
                                                    </li>
                                                    <li class="fw-semibold text-muted"><i
                                                            class="fs-3 fas fa-check-square text-success me-3"
                                                            style="line-height: 1.20em !important;"></i> Reskin CRM</li>
                                                    <li class="fw-semibold text-muted"><i
                                                            class="fs-3 fas fa-check-square text-success me-3"
                                                            style="line-height: 1.20em !important;"></i> Reskin Landingpage
                                                        & Toko
                                                        Online</li>
                                                    <li class="fw-semibold text-muted"><i
                                                            class="fs-3 fas fa-check-square text-success me-3"
                                                            style="line-height: 1.20em !important;"></i> Reskin Invoice &
                                                        Pembayaran
                                                    </li>
                                                    <li class="fw-semibold text-muted"><i
                                                            class="fs-3 fas fa-check-square text-success me-3"
                                                            style="line-height: 1.20em !important;"></i> Reskin AI
                                                        (Kecerdasan
                                                        Buatan)
                                                    </li>
                                                    <li class="fw-semibold text-muted"><i
                                                            class="fs-3 fas fa-check-square text-success me-3"
                                                            style="line-height: 1.20em !important;"></i> Training Online
                                                        via
                                                        Zoom/Google Meet</li>
                                                </ul>
                                                <hr class="border-secondary my-4">
                                                ...
                                                <ul class="list-unstyled mb-4 custom-list">
                                                    <li class="fw-semibold text-muted"><i
                                                            ...
                                                            style="line-height: 1.20em !important;"></i> Aplikasi Reskin -
                                                        Appsensi
                                                        Untuk Absensi & Kunjungan Online Staff/Sales</li>
                                                    <li class="fw-semibold text-muted"><i
                                                            class="fs-3 fas fa-star text-warning me-3"
                                                            style="line-height: 1.20em !important;"></i> Menambahkan Role
                                                        Staff
                                                        dalam
                                                        Aplikasi (Kasir, Keuangan, Admin, dan lainnya)</li>
                                                    <li class="fw-semibold text-muted"><i
                                                            class="fs-3 fas fa-star text-warning me-3"
                                                            style="line-height: 1.20em !important;"></i> Menambahkan 1
                                                        Cabang
                                                        / Bisnis Lain
                                                    </li>
                                                    <li class="fw-semibold text-muted pt-3"><i
                                                            class="fs-3 fas fa-crown me-3"
                                                            style="line-height: 1.20em !important; color: #00A6F6;"></i>
                                                        Dashboard
                                                        Reskin Owner (Kontrol banyak Bisnis dalam 1 Dashboard)</li>
                                                    <li class="fw-semibold text-muted pt-3"><i
                                                            class="fs-3 fas fa-crown me-3"
                                                            style="line-height: 1.20em !important; color: #00A6F6;"></i>
                                                        Upload Produk, Bahan Baku, Barang Setengah Jadi + Setting Modal +
                                                        Setting Akun (Tinggal Pakai Doang)</li>
                                                </ul>
                                                <hr class="border-secondary my-4">
                                        ...
                                        <div class="col-lg-4 mb-3">
                                            <div class="border rounded-4 p-4 bg-white shadow">
                                                ...
                                                <ul class="list-unstyled mb-4 custom-list">
                                                    ...
                                                    <li class="fw-semibold text-muted"><i
                                                            class="fs-3 fas fa-check-square text-success me-3"
                                                            style="line-height: 1.20em !important;"></i> Training Offline
                                                        (Visit) &
                                                        Online</li>
                                                </ul>
                                                <hr class="border-secondary my-4">
                                                ...
                                                <ul class="list-unstyled mb-4 custom-list">
                                                    ...
                                                    <li class="fw-semibold text-muted pt-3"><i
                                                            class="fs-3 fas fa-crown me-3"
                                                            style="line-height: 1.20em !important; color: #00A6F6;"></i>Bisa
                                                        Request Tambahan Fitur / Modifikasi / Integrasi</li>
                                                </ul>
                                                <hr class="border-secondary my-4">
                                                <div class="d-flex justify-content-center">
                                                    <form
                                    ...
                                    @if ($data['premium tahunan plus']->is_active)
                                        <div class="col-lg-4 mb-3">
                                            <div class="border rounded-4 p-4 bg-white shadow">
                                                ...
                                                <hr class="border-secondary my-4">
                                                <p class="mb-2">Fitur Tambahan Premium Tahunan + Setting Setting Aplikasi
                                                </p>
                                                <ul class="list-unstyled mb-4 custom-list">
                                                    ...
                                                    <li class="fw-semibold text-muted"><i
                                                            class="fs-3 fas fa-star text-warning me-3"
                                                            style="line-height: 1.20em !important;"></i> Menambahkan 5
                                                        Cabang
                                                        Bisnis
                                                    </li>
                                                    <li class="fw-semibold text-muted pt-3"><i
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <form
                                                        ...
                                                        <button type="submit"
                                                            class="btn btn-warning fw-semibold hover:animate-move-up rounded"><span
                                                                class="text-white">AMBIL Reskin PLUS</span></button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
