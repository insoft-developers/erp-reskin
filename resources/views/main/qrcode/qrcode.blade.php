                                ...
                                <div class="row">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" id="jml_meja" name="jml_meja" placeholder="Jumlah Meja"
                                        ...
                                        <div class="col-md-4 mt-4">
                                            <button style="margin-top: -10px;" id="submitMeja" class="btn bg-primary-gradient btn-primary btn-effect">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 float-end text-end">
                                            <div id="checkedValue" class="d-flex mt-4 d-none">
                                                <button class="btn bg-danger-gradient btn-danger btn-effect" id="bulk-delete-btn"
                                                    style="margin-right:5px"><i class="fa fa-trash mr-2"></i> Hapus
                                                    Data</button>
                                                <button class="btn bg-success-gradient btn-success btn-effect bulk-status-btn" id="bulk-available-btn"
                                                    data-status="Available" style="margin-right:5px"><i
                                                        class="fa fa-pencil mr-2"></i> Set Available</button>
                                                <button class="btn bg-warning-gradient btn-warning btn-effect bulk-status-btn" id="bulk-reserved-btn"
                                                    data-status="Reserved"><i class="fa fa-pencil mr-2"></i> Set
                                                    Reserved</button>
                                            </div>
                                        </div>
                                    </div>
                ...
                columns: [{
                        ...
                        render: function(data, type, row, meta) {
                            return '<div class="item-checkbox ms-1 single-item">' +
                                ...
                                '<input type="checkbox" class="custom-control-input checkbox" id="checkBox_' +
                                data + '" value="' + row.id + '#' + row.no_meja + '#' + row
                                .availability + '">' +
                                '<label class="custom-control-label" for="checkBox_' + data +
                                '"></label>' +
                                '</div>' +
                                '</div>'
                        },
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            return '<div class="d-flex">' +
                                '<button class="btn bg-primary-gradient btn-primary btn-effect open-modal-btn" style="margin-right:5px" data-meja="' +
                                row.no_meja + '" data-number="' + row.qr_id + '" data-qrcode="' +
                                row.qr_code + '" data-available="' + row.availability +
                                '" ><i class="fa fa-eye"></i> &nbsp; Detail</button>' +
                                '<button class="btn bg-success-gradient btn-success btn-effect edit-modal-btn mr-3" style="margin-right:5px" data-id="' +
                                row.id + '" data-meja="' + row.no_meja + '" data-number="' + row
                                .qr_id + '" data-available="' + row.availability +
                                '"><i class="fa fa-pencil"></i> &nbsp; Edit</button>' +
                                '<button class="btn bg-danger-gradient btn-danger btn-effect btn-hapus mr-3" data-key="' +
                                row.id + '"><i class="fa fa-trash"></i> &nbsp; Hapus</button>' +
                                '</div>'
                        },
                        orderable: false
                    }
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            ...
                            .fail(function() {
                                swal.fire('Oops...', 'Something went wrong with data !',
                                    'error');
                            });
                    }
