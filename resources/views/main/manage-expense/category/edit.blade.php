            ...
            <div class="main-content">
                <div class="row">
                    ...
                    <div class="col-xxl-12">
                        ...
                        @endif
                        <form method="POST" action="{{ route('expense.category.update', [$data->id]) }}"
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped " id="data-table">
                                    ...
                                    <tbody id="contentTable">
                                        @foreach ($data->md_expense_category_product as $item)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $item->md_product->name ?? null }}</td>
                                                <td>
                                                    <div style="width: 40px;">
                                                        <a href="{{ route('expense.category.deleteProduct', [$item->id]) }}"
...
@section('js')
    <script>
        ...
        var no = parseInt('{{ $data->md_expense_category_product->count() + 1 }}');
