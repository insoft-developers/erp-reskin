                            ...
                            <div class="card-header">
                                <h5 class="card-title">List Pengeluaran</h5>
                                    ...
                                    @if ($data['count_cat_expense'] > 0)
                                        <button style="float:right;" onclick="createData()" class="btn btn-success m-2">
                                            <i class="fa fa-plus"></i> Buat Baru
                                        </button>
                                    @else
                                        <a href="javascript:void(0)" onclick="redirectCreate()"><button style="float:right;"  class="btn btn-success m-2"><i class="fa fa-plus"></i> Buat Baru</button> </a>
                                    @endif
