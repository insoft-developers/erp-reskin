                                ...
                                <div class="card border-0 p-lg-3 shadow-lg rounded-2">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <h5 class="mb-2">Email atau Whatsapp terkirim!</h5>
                                            <p class="mb-0">Kami telah mengirimkan pesan ke email & whatsapp berupa link untuk aktivasi akun anda<br>
                                            Silahkan cek email atau whatsapp Anda.
                                            </p>
                                        </div>
                                        <div>
                                            <a href="{{ url('frontend_login') }}" class="btn bg-primary-gradient text-white w-100">Kembali Ke Halaman Login</a>
                                        </div>
                                        <div style="margin-top:20px;">
                                            <a href="{{ url('https://randu.co.id/chat/bantuan-aktivasi-akun') }}" target="_blank" class="btn bg-warning-gradient text-white w-100">Tidak menerima Link Aktivasi ?</a>
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                            </div>
