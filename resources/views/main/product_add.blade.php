                                ...
                                <div class="container mtop30 main-box">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" id="name"
                                                        ...
                                                        placeholder="Cth: Nasi Goreng Ikan Asin" oninput="generateSKU()">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="sku" id="sku"
                                                        class="form-control cust-control" placeholder="Contoh: NGIA">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="price_text" class="form-control cust-control"
                                                    placeholder="Cth: 10.000">
                                                <input type="hidden" id="price" name="price">
                                            </div>
                                            <small class="help-text">Isi dengan nominal harga jual produk / barang. Jika
                                                bisnis FnB biasanya harga untuk Dine In (Makan di Tempat)</small>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Harga Delivery / Take Away (Opsional):</label>
                                                <input type="text" id="price_ta" name="price_ta"
                                                    class="form-control cust-control" placeholder="Cth: 11.000">
                                            </div>
                                            <small class="help-text">Isi jika perlu harga yang berbeda jika pesanannya
                                                dikirim / dibawa pulang</small>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Harga Marketplace (Opsional):</label>
                                                <input type="text" id="price_mp" name="price_mp"
                                                    class="form-control cust-control" placeholder="Cth: 14.000">
                                            </div>
                                            <small class="help-text">Isi jika perlu harga yang berbeda khusus untuk
                                                Shopee, Tokopedia, GrabFood, GoFood DLL</small>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Harga Custom (Opsional):</label>
                                                <input type="text" id="price_cus" name="price_cus"
                                                    class="form-control cust-control" placeholder="Cth: 15.000">
                                            </div>
                                            <small class="help-text">Isi jika perlu harga jual yang berbeda
                                                Lainnya</small>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" role="switch"
                                                    id="detailProductInput" style="width: 4em; padding: 15px;">
                                                <label class="form-check-label" style="padding-top: 8px;padding-left: 8px;"
                                                    for="flexSwitchCheckDefault">Tambahkan Detail Produk (Jika
                                                    Dibutuhkan)</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="detailProduct" style="display: none;">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control cust-control" id="is_variant"
                                                            ...
                                                            <option value="1" <?php echo 'selected'; ?>>Single Product
                                                                (Tanpa Varian)
                                                            </option>
                                                            <option value="2">Varian Product (Dengan Varian)
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="p-4 bg-soft-warning rounded-3">
                                                        <p class="fs-12 text-dark"><strong>Single
                                                            ...
                                                            memungkinkan pelanggan memilih hanya satu varian dari
                                                            beberapa
                                                            pilihan yang tersedia. Cocok untuk produk yang hanya bisa
                                                            dipilih satu varian, seperti satu ukuran atau satu warna
                                                            pakaian
                                                            per transaksi.
                                                        </p>
                                                        <p class="fs-12 text-dark"><strong>Max
                                                                Quantity</strong><br>Opsi
                                                            "Max Quantity" membatasi jumlah maksimal varian yang bisa
                                                            dipilih dalam satu transaksi. Berguna untuk mengelola stok
                                                            dan
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control cust-control" id="buffered_stock"
                                                        ...
                                                        <option <?php echo 'selected'; ?> value="0"> No - Jangan Gunakan
                                                            Stok</option>
                                                        <option value="1">Yes - Gunakan Stok</option>

                                                    </select>
                                                    <small class="help-text">Buffer Stock / Gunakan Stok Produk
                                                        Otomatis. Jika "YES" maka produk tidak akan bisa dipesan ketika
                                                        stoknya 0*</small>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <small class="help-text">Jika stok produk 10 dan stok di tahan adalah
                                                    2, maka hanya 8 yang bisa dipesan</small>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control cust-control" id="is_manufactured"
                                                            ...
                                                            <option value="1" <?php echo 'selected'; ?>>Beli Jadi
                                                            </option>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    ...
                                                                    name="created_by" id="created_by_0" value="0"
                                                                    checked>
                                                                <label class="form-check-label" for="created_by_0">Dibuat
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    onclick="bufferedStockChangeCreatedBy()"
                                                                    name="created_by" id="created_by_1" value="1">
                                                                <label class="form-check-label" for="created_by_1">Dibuat
                                                                    By Pesanan</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="p-4 bg-soft-warning rounded-3">
                                                            <p class="fs-12 text-dark"><strong>Produk yang Dibuat
                                                                    Terlebih Dahulu (Make-to-Stock)</strong><br>adalah
                                                                produk yang diproduksi dan disimpan dalam stok sebelum
                                                                ada permintaan spesifik dari pelanggan. Contohnya: Roti,
                                                                Kue, Fashion, Furniture, dan lain-lain
                                                            </p>
                                                            <p class="fs-12 text-dark"><strong>Produk yang Dibuat
                                                                    Berdasarkan Pesanan
                                                                    (Make-to-Order)</strong><br>adalah produk yang hanya
                                                                diproduksi setelah ada pesanan dari pelanggan.
                                                                Contohnya: nasi Goreng, Kentang Goreng, Kopi, dan
                                                                lain-lain
                                                            </p>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row mtop30">
                                            ...
                                            <div class="col-md-12">
                                                <div class="p-4 bg-soft-warning rounded-3">
                                                    <p class="fs-12 text-dark"><strong>Bingung Nulis Deskripsi? Pakai
                                                            Randu AI</strong><br>Ketik pada Randu AI "Buatkan saya
                                                        deskripsi untuk produk Nasi Goreng Ikan Asin" maka Randu AI akan
                                                        membuatkan deskripsi produk yang keren buat produkmu.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
