        ...
        <div class="content" style="background: whitesmoke;">
            <div class="row">
                ...
                <div class="col-xxl-12">
                    ...
                    @endif
                    <form method="POST" action="{{ route('adjustment.store') }}" class="card stretch stretch-full"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <h5 class="card-title">Penyesuaian Barang Dagang</h5>
                        </div>
                        <div class="card-body custom-card-action p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-control @error('product_id') is-invalid @enderror" id="searchProduct"
                        ...
                        <div class="card-footer d-flex justify-content-start">
                            <a href="{{ route('adjustment.index') }}" class="btn btn-danger me-2">Kembali</a>
