        ...
        <div class="content" style="background: whitesmoke;">
            <div class="row">
                ...
                <div class="col-xxl-12">
                    ...
                    @endif
                    <form method="POST" action="{{ route('adjustment.storeInterProduct') }}" class="card stretch stretch-full"
                        ...
                        <div class="card-body custom-card-action p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-control @error('md_inter_product_id') is-invalid @enderror"
                                    id="searchProduct" name="md_inter_product_id" value="{{ old('md_inter_product_id') }}">
                                </select>
