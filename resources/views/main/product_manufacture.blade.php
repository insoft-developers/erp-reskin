            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Transaksi Buat Produk</li>
                    </ul>
                </div>
...
<div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
    <h5 class="card-title" style="margin: 0;">Transaksi Buat Produk</h5>
    <button onclick="add_data()" 
        class="btn btn-sm btn-success" 
        data-bs-toggle="dropdown" 
        data-bs-auto-close="outside" 
        style="display: flex; align-items: center;">
        <i class="feather-plus"></i>&nbsp;&nbsp;Tambah Transaksi Produk Manufaktur
    </button>
</div>
                                        ...
                                        <table id="table-inter-purchase" class="table table-striped mb-0 table-bordered">
                                            <thead>
                                                <tr class="border-b">
                                                    ...
                                                    <th width="*">Barang Yang di Produksi</th>
