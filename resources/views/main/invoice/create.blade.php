            ...
            <div class="col-xxl-12">
                <div class="card stretch stretch-full">
                    ...
                    <div class="card-body custom-card-action p-3">
                        <form action="{{ route('invoice.invoice.store') }}" method="POST" enctype="multipart/form-data"
                            id="formCreate">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="invoiceNumber"
                                        placeholder="Nomor Invoice" name="invoice_number">
                                </div>
                                ...
                                <script>
                                    document.addEventListener('DOMContentLoaded', function() {
                                        ...
                                        function generateSequentialNumber() {
                                            ...
                                            let randomNumber = Math.floor(Math.random() * 100).toString().padStart(2,
                                                '0'); // Angka acak antara 00 dan 99
                                ...
                                <div class="col-md-6 mb-3" id="formPayTo">
                                    ...
                                    <small style="color: #385a9c; font-family: italic;">Aktifkan Metode Pembayaran
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="invoiceDate"
                                        value="{{ now()->format('Y-m-d') }}" name="created">
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea class="form-control" rows="5"
                                        ...
                                        name="additional_intruction"></textarea>
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label for="dueDate" class="form-label">Jatuh Tempo</label>
                                    <input type="date" class="form-control" id="dueDate"
                                        value="{{ now()->format('Y-m-d') }}" name="due_date">
                                </div>
                                ...
                                <div class="col-md-6 mb-3" id="formCurrency">
                                    ...
                                    <small style="color: #385a9c; font-family: italic;">Pilih Mata Uang Yang
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-2">
                                            ...
                                            <select name="discount_type" class="form-control" onchange="updateTotals();"
                                                id="discount_type">
                                        ...
                                        <div class="col-md-10 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="discount" placeholder="10"
                                                name="discount_value">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exchangeRate" placeholder="15000"
                                        name="kurs" value="1">
                                    <small style="color: #385a9c; font-family: italic;">Kurs Mata Uang dalam Indonesian
                                        Rupiah (Rp)</small>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" oninput="updateTotals();"
                                            id="taxRate" placeholder="10" value="{{ $data['tax'] }}" name="tax"
                                            step="0.01">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <textarea class="form-control ckeditor" id="" cols="30" rows="5"
                                                            placeholder="Deskripsi Tambahan" name="description[]"></textarea>
                                                    </td>
                                                    ...
                                                    <td style="vertical-align: top;"><input type="number"
                                                            oninput="updateTotals();" class="form-control qty"
                                                            min="1" value="1" name="qty[]"></td>
                            ...
                            <div class="row mt-3 mb-3">
                                <div class="col-md-7">
                                    ...
                                    <textarea class="form-control ckeditor" rows="8"
                                        placeholder="Mohon pastikan pembayaran dilakukan dalam waktu 30 hari menggunakan detail akun yang tersedia pada invoice. Jika Anda memiliki pertanyaan, silakan hubungi tim keuangan kami di (021) 555-1234 atau melalui email di mail@randu.co.id. Kami menghargai kemitraan Anda dan menantikan kerja sama yang berkelanjutan."
                                        name="notes"></textarea>
                                </div>
                                <div class="col-md-5">
