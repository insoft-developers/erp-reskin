                ...
                <div class="col-xxl-12">
                    <div class="card stretch stretch-full">
                        ...
                        <div class="card-body custom-card-action p-3">
                            <form action="{{ route('invoice.invoice.update', $data['id']) }}" method="POST"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col">
                                        <h5>Is Quotation</h5>
                                        <div class="mb-3">
                                            <select class="form-control select2" id="is_quotation" name="is_quotation"
                                                required>
                                                <option value="0" {{ $data->is_quotation == 0 ? 'selected' : '' }}>
                                                    Invoice</option>
                                                <option value="1" {{ $data->is_quotation == 1 ? 'selected' : '' }}>
                                                    Quotation</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col">
                                        <h5>Dari</h5>
                                        <div class="mb-3">
                                            <select class="form-control select2" id="invoice_from" name="invoice_from"
                                                value="{{ $data['invoice_from'] }}">
                                                <option value="">Pilih Opsi</option>
                                                <option value="perusahaan"
                                                    {{ $data->invoice_from == 'perusahaan' ? 'selected' : '' }}>Perusahaan
                                                </option>
                                                <option value="personal"
                                                    {{ $data->invoice_from == 'personal' ? 'selected' : '' }}>Personal
                                                </option>
                                            </select>
                                        </div>
                                        <div id="formInvoiceFrom">
                                            <div class="mb-3">
                                                <input type="text" class="form-control" placeholder="Business Name"
                                                    value="{{ $data->from_name }}" disabled>
                                            </div>
                                            <div class="mb-3">
                                                <input type="email" class="form-control" placeholder="name@business.com"
                                                    value="{{ $data->from_email }}" disabled>
                                            </div>
                                            <div class="mb-3">
                                                <input type="text" class="form-control" placeholder="Street"
                                                    value="{{ $data->from_address }}" disabled>
                                            </div>
                                            <div class="mb-3">
                                                <input type="text" class="form-control" placeholder="(123) 456 789"
                                                    value="{{ $data->from_phone }}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        ...
                                        <div class="mb-3" id="formClientId">
                                            <select class="form-control" id="client_id" name="client_id"
                                                ...
                                                <option value="{{ $data['client_id'] }}">{{ $data->client->name ?? null }}
                                                </option>
                                            </select>
                                        </div>
                                        <div id="clientDetail">
                                            <div class="mb-3">
                                                <input type="text" class="form-control" placeholder="Client Name"
                                                    value="{{ $data->client->name ?? null }}" disabled>
                                            </div>
                                            <div class="mb-3">
                                                <input type="email" class="form-control" placeholder="name@client.com"
                                                    value="{{ $data->client->email ?? null }}" disabled>
                                            </div>
                                            <div class="mb-3">
                                                <input type="text" class="form-control" placeholder="Street"
                                                    value="{{ $data->client->address ?? null }}" disabled>
                                            </div>
                                            <div class="mb-3">
                                                <input type="text" class="form-control" placeholder="(123) 456 789"
                                                    value="{{ $data->client->phone ?? null }}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="invoiceNumber"
                                            placeholder="INV0002" name="invoice_number"
                                        ...
                                        <select class="form-control" id="payment_method" name="payment_method">
                                            ...
                                            @foreach ($typePayment as $item)
                                                <option value="{{ $item['code'] }}"
                                                    {{ $data['payment_method'] == $item['code'] ? 'selected' : '' }}>
                                                    {{ $item['method'] }}</option>
                                            @endforeach
                                        </select>
                                        <small style="color: #feb240; font-family: italic;">Aktifkan Metode Pembayaran
                                            Melalui Pengaturan Pembayaran</small>
                                    </div>

                                    <div class="col-md-6 mb-3">
                                        <label for="invoiceDate" class="form-label">Tanggal Dibuat</label>
                                        <input type="date" class="form-control" id="invoiceDate" name="created"
                                            value="{{ $data['created'] }}">
                                    </div>

                                    <div class="col-md-6 mb-3">
                                        <label for="additional_intruction" class="form-label">Additional
                                            Intructions</label>
                                        <textarea class="form-control" rows="5"
                                            placeholder="SWIFT/BIC Code: CENAIDJA &#10;Bank Address: BCA KCU Diponegoro, Dr. Soetomo Street No.118, Darmo Sub-District, Wonokromo District, Surabaya City, East Java, Indonesia 60241"
                                            name="additional_intruction">{{ $data->additional_intruction }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3" id="formCurrency">
                                        ...
                                        <select class="form-control" id="currency_id" name="currency"
                                            ...
                                            <option value="{{ $data->currency_id }}">
                                                {{ $data->currency->code . ' - ' . $data->currency->name }}</option>
                                        </select>
                                        <small style="color: #feb240; font-family: italic;">Pilih Mata Uang Yang
                                            ditampilkan di Invoice</small>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                ...
                                                <select name="discount_type" class="form-control"
                                                    onchange="updateTotals();" id="discount_type">
                                                    <option value="nominal"
                                                        {{ $data['discount_type'] == 'nominal' ? 'selected' : '' }}>Value
                                                    </option>
                                            ...
                                            <div class="col-md-10 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="discount"
                                                    placeholder="10" name="discount_value"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exchangeRate" placeholder="15000"
                                            name="kurs" value="{{ number_format($data['kurs'], 0, ',', '.') }}"
                                            value="1">
                                        <small style="color: #feb240; font-family: italic;">Kurs Mata Uang dalam Indonesian
                                            Rupiah (Rp)</small>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" oninput="updateTotals();"
                                                id="taxRate" placeholder="10" value="{{ $data['tax'] }}"
                                                name="tax" value="{{ $data['tax'] }}" step="0.01">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <input type="text" class="form-control"
                                                        placeholder="Deskripsi Singkat" name="short_description[]"
                                                        value="{{ $item['short_description'] }}">
                                                    <br>
                                                    <textarea class="form-control ckeditor" id="" cols="30" rows="5"
                                                        placeholder="Deskripsi Tambahan" name="description[]">{{ $item['description'] }}</textarea>
                                                </td>
                                                <td style="vertical-align: top;"><input type="text"
                                                        oninput="numberFormat(this);" class="form-control harga"
                                                        name="price[]"
                                                        value="{{ number_format($item['price'], 0, ',', '.') }}"></td>
                                                <td style="vertical-align: top;"><input type="number"
                                                        oninput="updateTotals();" class="form-control qty" min="1"
                                                        name="qty[]" value="{{ $item['qty'] }}"></td>
                                                <td style="vertical-align: top;" class="total">
                                                    {{ $data->currency->code . '. ' . number_format($item['sub_total']) }}
                                                </td>
                                                <td style="vertical-align: top;"><button type="button"
                                                        class="btn btn-danger" onclick="removeRow(this)">Hapus</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                        ...
                                        <table border="0" class="table">
                                            <tr>
                                                ...
                                                <td class="text-end" id="subTotal">
                                                    {{ $data->currency->code . '. ' . $data->sub_total }}</td>
                                            </tr>
                                            <tr>
                                                <th>Pajak</th>
                                                <td>:</td>
                                                <td class="text-end" id="taxAmount">
                                                    {{ $data->currency->code . '. ' . $data->tax_amount }}</td>
                                            </tr>
                                            <tr>
                                                <th>Diskon</th>
                                                <td>:</td>
                                                <td class="text-end" id="discountAmount">
                                                    {{ $data->currency->code . '. ' . $data->discount_amount }}</td>
                                            </tr>
                                            <tr>
                                                <th><strong>GRAND TOTAL</strong></th>
                                                <td>:</td>
                                                <td class="text-end"><strong
                                                        id="grandTotal">{{ $data->currency->code . '. ' . $data->grand_total }}</strong>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="signatureField"
                                                {{ $data['signature_name'] != null ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>

                                <div class="row mb-3" id="formSignature"
                                    {{ $data['signature_name'] == null ? 'hidden' : '' }}>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="signature_name"
                                            id="signature_name" value="{{ $data['signature_name'] }}"
                                            placeholder="Nama">
                                        <input type="text" class="form-control mt-2" name="signature_position"
                                            id="signature_position" value="{{ $data['signature_position'] }}"
                                            placeholder="Jabatan">
                                    </div>
                                </div>
            ...
            $.ajax({
                ...
                .done(function(data) {
                    ...
                    var elem = `<div class="mb-3">
                        ...
                        <div class="mb-3">
                            <input type="email" class="form-control" placeholder="name@client.com" value="` + data
                        .email + `" disabled>
                        </div>
                        <div class="mb-3">
            ...
            $.ajax({
                ...
                .done(function(data) {
                    ...
                    var elem = `<div class="mb-3">
                        ...
                        <div class="mb-3">
                            <input type="email" class="form-control" placeholder="name@business.com" value="` + data
                        .email + `" disabled>
                        </div>
                        <div class="mb-3">
                            <input type="text" class="form-control" placeholder="Street" value="` + data.address + `" disabled>
