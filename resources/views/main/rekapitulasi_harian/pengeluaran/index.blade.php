            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Pengeluaran Builder</li>
                    </ul>
                </div>
...
@section('js')
    <script type="text/javascript">
        ...
        function filter() {
            ...
            init_table(keyword, bulan, tahun);
        }

        function init_table(keyword = '', bulan = '', tahun = '') {
            var csrf_token = $('meta[name="csrf-token"]').attr('content');
        ...
        function deleteData(event, id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                            url: "{{ route('pengeluaran.destroy', ':id') }}".replace(':id', id),
                            type: 'POST',
                            data: postForm,
                            dataType: 'json',
                        })
        ...
        function bulkDelete(ids) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                            url: "{{ route('pengeluaran.destroyAll') }}",
                            type: 'POST',
                            data: postForm,
                            dataType: 'json',
                        })
        ...
        function editData(id) {
            $.ajax({
                    url: "{{ route('pengeluaran.edit', ':id') }}".replace(':id', id),
                    type: 'GET',
                })
                .done(function(data) {
                    $('#content-modal-ce').html(data);
        ...
        function sync_process(id) {
            var csrf_token = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                url: "{{ route('pengeluaran.single.sync') }}",
                type: "POST",
                dataType: "JSON",
                data: {
                    "id": id,
        ...
        function unsync_process(id) {
            var csrf_token = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                url: "{{ route('pengeluaran.single.unsync') }}",
                type: "POST",
                dataType: "JSON",
                data: {
                    "id": id,
