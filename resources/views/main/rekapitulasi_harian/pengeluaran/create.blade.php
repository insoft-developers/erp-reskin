<form method="POST" id="formCreate" action="{{ route('pengeluaran.store') }}" enctype="multipart/form-data">
    @csrf
            ...
            <div class="mb-4">
                <div class="col-12 col-xxl-12">
                    ...
                    <input type="datetime-local" class="form-control @error('created_at') is-invalid @enderror"
                        id="created_at" name="created_at" value="{{ old('created_at', now()) }}" placeholder="Input Tanggal">
                    </input>
                    @error('created_at')
