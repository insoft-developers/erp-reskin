    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#modal-tambah form").submit(function(e) {
                ...
                $("#loading-image").show();
                var id = $("#id").val();
                if (save_method == 'add') url = "{{ url('inter_purchase') }}";
                else url = "{{ url('inter_purchase') }}" + "/" + id;
                $.ajax({
                    url: url,
                    type: "POST",
                    dataType: "JSON",
        ...
        function add_data() {
            ...
            $(".modal-title").text("Tambah Transaksi Barang Setengah Jadi");
            resetData();
        }
        ...
        var table = $('#table-inter-purchase').DataTable({
            ...
            ajax: "{{ route('inter.purchase.table') }}",
            order: [
                [1, "desc"]
            ],
            columns: [{
