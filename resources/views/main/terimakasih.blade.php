        ...
        <div class="auth-cover-sidebar-inner" style="background: #2f467a;box-shadow: unset;">
            <div class="auth-cover-card-wrapper">
                <div class="auth-cover-card p-sm-5">
                    ...
                    <h2 class="fs-20 fw-bolder mb-4 text-white">Verifikasi Dulu Yah.....</h2>
                    <h4 class="fs-13 fw-bold mb-2 text-white">Kami telah mengirimkan pesan ke <b>WhatsApp & Email</b>
                        berisikan
                        link untuk aktivasi akun.</h4>
                    <p style="margin-top: 40px;" class="fs-12 fw-medium text-white">Silakan cek pesan WhatsApp atau
                        email dan klik
                        Link aktivasi tersebut...</p>


                    <div class="mt-3">
                        <a href="{{ url('/') }}"><button type="submit"
                                class="btn btn-lg btn-primary w-100">Kembali Ke Halaman Login</button></a>
                    </div>
                    <div class="mt-3">
                        <a href="{{ url('https://randu.co.id/chat/bantuan-aktivasi-akun') }}" target="_blank">
                            <button type="submit" class="btn btn-lg btn-primary w-100"
                                style="background-color: #E67E22 !important; color: #ffffff !important;">Tidak Menerima
                                Link Aktivasi?</button>
                        </a>
                    </div>
