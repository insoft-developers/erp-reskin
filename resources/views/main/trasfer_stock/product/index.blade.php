        ...
        <div class="nxl-content">
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('transfer-stock.product.index') }}">Transfer Stok Barang Jadi</a></li>
                        <li class="breadcrumb-item">Transfer Stok Barang Jadi Builder</li>
                    </ul>
                </div>
                    ...
                    <div class="col-xxl-12">
                        <div class="card stretch stretch-full">
                            <div class="card-header">
                                <h5 class="card-title">Transfer Stok Barang Jadi</h5>
                                    ...
                                    <table class="table table-striped" id="data-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Action</th>
                                                <th>Produk Yang Ditransfer</th>
                                                <th>Jumlah Stok Yang Di Kurangi</th>
                                                <th>Produk Yang Dituju</th>
    ...
    <script type="text/javascript">
        ...
        function init_table(keyword = '', type_category = '', bulan = '', tahun = '') {
            ...
            var table = $('#data-table').DataTable({
                ...
                ajax: {
                    type: "GET",
                    url: "{{ route('transfer-stock.product_data') }}",
                    data: {
                        'keyword': keyword,
                        'bulan': bulan,
                        'tahun': tahun
        ...
        function deleteData(event, id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                            url: "{{ route('transfer-stock.product.destroy', ':id') }}".replace(':id', id),
                            type: 'POST',
                            data: postForm,
                            dataType: 'json',
                        })
        ...
        function createData() {
            $.ajax({
                    url: "{{ route('transfer-stock.product.create') }}",
                    type: 'GET',
                })
                .done(function(data) {
        ...
        function detail(id) {
            $.ajax({
                    url: "{{ route('transfer-stock.product.show', ':id') }}".replace(':id', id),
                    type: 'GET',
                })
                .done(function(data) {
                    $('#content-modal-ce').html(data);
