    ...
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="#" class="b-brand">
                ...
                <span class="brand-title">Randu App</span>
                <img src="{{ asset('template/main') }}/images/logo.png" alt="" class="logo logo-sm" />
            </a>
        </div>
        <!-- Define Role
                role diambil dari session 'role'.
                @role('staff, general_member, admin')
    menu name
@endrole
            -->
        <div class="navbar-content">
            <ul class="nxl-navbar">
                @role('owner', 'general_member, premium_member, verified_member, administrator')
                    <li class="nxl-item nxl-hasmenu">
                        <a href="{{ url('/') }}" class="nxl-link">
                            <span class="nxl-micon">
                                <img class="img-menu" src="{{ asset('template/main/images/menu/menu-jurnal.png') }}">
                            </span>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            ...
                            {{-- <li class="nxl-item"><a class="nxl-link"
                                    href="{{ route('rekapitulasi-harian.index') }}">Rekapitulasi Harian</a></li> --}}
                    ...
                    <li class="nxl-item nxl-hasmenu d-nonex">
                        <a href="{{ route('whatsapp-provider.index') }}" class="nxl-link">
                            <span class="nxl-micon">
                                <img class="img-menu"
                                    src="{{ asset('https://randu.co.id/development/chatbot.png') }}">
                            </span>
                            <span class="nxl-mtext menu-text">Customer Service AI</span><br>
                            <span class="nxl-mtext menu-subtitle">ChatBot AI & Kirim Struk WhatsApp</span>
                        </a>
                    </li>

                    <li class="nxl-item nxl-hasmenu">
                        <a href="{{ url('feature-request') }}" class="nxl-link">
                            <span class="nxl-micon"><img class="img-menu"
                                    src="{{ asset('template/main/images/menu/menu-feature-request.png') }}"></span>
                            <span class="nxl-mtext menu-text">Permintaan Fitur Baru</span><br>
                            <span class="nxl-mtext menu-subtitle">Saran fitur baru</span>
                        </a>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a onclick="add_product_module()" class="nxl-link"
                                    href="javascript:void(0);">Tambah Produk &
                                    Barang </a>
                            </li>
                            <li class="nxl-item"><a class="nxl-link" href="{{ url('product') }}">Daftar Produk &
                                    Barang</a>
                            </li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0)" class="nxl-link">
                            ...
                            <span class="nxl-mtext menu-text">COGS Manufaktur</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span><br>
                            <span class="nxl-mtext menu-subtitle">Bahan Baku & Barang ½ Jadi</span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            ...
                            <li class="nxl-item"><a class="nxl-link" href="{{ url('product_manufacture') }}">Transaksi
                                    Buat Produk
                                    (Manufaktur)</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="{{ url('inter_purchase') }}">Transaksi Buat
                                    Barang ½ Jadi</a>
                            </li>
                            ...
                            <li class="nxl-item"><a class="nxl-link"
                                    ...
                                    <li class="nxl-item"><a class="nxl-link"
                                        href="{{ url('converse') }}">Konversi Bahan/Proses Produksi</a></li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            ...
                            <li class="nxl-item"><a class="nxl-link"
                                    ...
                                    <li class="nxl-item"><a class="nxl-link"
                                        href="{{ route('adjustment.stock.opname') }}">Stock Opname</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="{{ route('penyusutan.index') }}" class="nxl-link">
                            ...
                            <span class="nxl-mtext menu-text">Aset & Penyusutan</span><br>
                ...
                @role('owner', 'general_member, premium_member, verified_member, administrator')
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext menu-text">Biaya (Expenses)</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span><br>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext menu-text">QR Meja / QR Pesan</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span><br>
                   ...
                   <li class="nxl-item nxl-hasmenu d-none">
                        <a href="{{ route('whatsapp-provider.index') }}" class="nxl-link">
                            <span class="nxl-micon">
                                <img class="img-menu"
                                    src="{{ asset('template/main/images/menu/menu-customer-service.png') }}">
                            </span>
                            <span class="nxl-mtext menu-text">Whatsapp Provider</span><br>
                            <span class="nxl-mtext menu-subtitle">Manajemen Customer Service</span>
                        </a>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                ...
                @role('owner', 'general_member, premium_member, verified_member, administrator')
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            ...
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('storefront-setting') }}">Pengaturan
                                    Toko Online</a></li>
                            <li class="nxl-item"><a class="nxl-link"
                                    href="{{ url('payment-method-setting') }}">Pengaturan
                                    Pembayaran</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><img class="img-menu"
                                    src="{{ asset('template/main/images/menu/menu-appsensi.png') }}"></span>
                            <span class="nxl-mtext menu-text">AppSensi Staff</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span><br>
                            <span class="nxl-mtext menu-subtitle">Laporan Absensi Staff</span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('visit.index') }}">Laporan
                                    Kunjungan</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('laporan.absensi.index') }}">Laporan
                                    Absensi Bulanan</a></li>
                            <li class="nxl-item"><a class="nxl-link"
                                    href="{{ route('laporan.absensi.indexByDate') }}">Laporan Absensi Harian</a></li>
                        </ul>
                    </li>
                    ...
                    @if (session('is_upgraded') == 1)
                        <li class="nxl-item nxl-hasmenu">
                            <a href="javascript:void(0);" class="nxl-link">
                                ...
                                <span class="nxl-mtext menu-text">Manajemen Staff</span><span class="nxl-arrow"><i
                                        class="feather-chevron-right"></i></span><br>
                                <span class="nxl-mtext menu-subtitle">Data Staff & Karyawan</span>
                            </a>
                            <ul class="nxl-submenu">
                                <li class="d-none nxl-item"><a class="nxl-link" href="{{ route('branch.index') }}">Data
                                        Cabang</a></li>
                    ...
                    @endif
                    <li class="d-none nxl-item nxl-hasmenu">
                        <a href="{{ url('report') }}" class="nxl-link">
                            <span class="nxl-micon"><img class="img-menu"
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            <span class="nxl-micon"><img class="img-menu"
                                    src="{{ asset('template/main/images/menu/menu-randu-katalog.png') }}"></span>
                            <span class="nxl-mtext menu-text">Randu Katalog</span><span class="nxl-arrow"><i
                                    class="feather-chevron-right"></i></span><br>
                            <span class="nxl-mtext menu-subtitle">Belanja Keperluan Bisnis</span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('katalog-randu.index') }}">Lihat
                                    Katalog</a></li>
                            <li class="nxl-item"><a class="nxl-link"
                                    href="{{ route('katalog-randu.transaction.index') }}">Histori Transaksi</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
