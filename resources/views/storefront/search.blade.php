		...
		<div class="container">
			<div class="header-content">
				<div class="left-content">
					...
					<h4 class="title mb-0 text-nowrap">Pencarian Produk</h4>
				</div>
...
<div class="page-content">
    <div class="container mb-5">
        <p>Hasil pencarian dari "{{$product}}"</p>
        @if($products)
            ...
            <div class="product-list">
				...
				<div class="text-end">
					<a href="{{route('product.detail', ['username' => $username, 'product' => $product->id])}}" class="dz-media media-100">
                        @if($product->url)
				            <img class="rounded-sm" src="{{ Storage::url('images/product/' . $product->url) }}" alt="image">
                        @else
