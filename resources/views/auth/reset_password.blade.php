            ...
            <div class="minimal-card-wrapper">
                ...
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative card-login">
                    ...
                    <div class="card-body p-sm-5">
                        ...
                        <form method="POST" action="{{ route('forgot_password.change_password') }}" class="w-100 pt-2">
                            @csrf
                            <div class="mb-3">
                                <input type="email" class="form-control d-none" name="email" value="{{ $email }}">
                            ...
                            <div class="mb-3">
                                <input type="password" id="password_confirmation" name="password_confirmation" class="form-control" placeholder="Konfirmasi Kata Sandi Baru">
